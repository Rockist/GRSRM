            ...
            {/* 네비게이션 부분 */}
              <div className="nav">
                ...
                <div className="confirm_container">
                  <table>
                    <tbody>
                      <tr className="ct_r1">
                        <th rowSpan={2} id="guljae"><span>결<br/><br/>재</span></th>
                        <th className='guljae-friend'>담당</th> 
                        <th className='guljae-friend'>검토</th> 
                        <th className='guljae-friend'>승인</th>
                      </tr>
                      <tr className="ct_r2" >
                        <td></td>
                        <td></td>
              ...
              <div className="supplyer_container">
                <table>
                  <tbody>
                    <tr>
                      <td className="t_center" rowSpan={5} id="t_rec_name">공<br/>급<br/>받<br/>는<br/>자</td>
                      <td className="t_center">등록 번호</td>
                      <td className="tl_width" colSpan={3} >{"503 - 81 - 53553"}</td>
                      <td className="t_center" rowSpan={5} id="t_sen_name" style={{borderLeftWidth: '4px', borderStyle: 'double'}}>공<br /><br />급<br /><br />자</td>
                      <td className="t_center">등록번호</td>
                      <td className="tl_width" colSpan={3} >{pdata.nestedList[0].BP_RGIST_NO}</td>
                    </tr>
                    <tr>
                      <td className="t_center">상{"   "}호</td>
                      <td className="ts_width" >{"거림테크 주식회사"}</td>
                      <td className="t_center">성{"   "}명</td>
                    ...
                    <tr>
                      <td className="t_center">업{"   "}태</td>
                      <td className="ts_width" >{"제조, 도매, 서비스"}</td>
                      <td className="t_center">종{"   "}목</td>
              ...
              <div className="contents_container">
                <table>
                  ...
                  <tr>
                      ...
                      <th className="t_center" id="name">품{"     "}명</th>
                      <th className="t_center" id="standard">규{"    "}격</th>
                      <th className="t_center" id="unit">단위
                      </th><th className="t_center" id="width">면{"    "}적</th>
                      <th className="t_center" id="roll">ROLL
                      </th><th className="t_center" id="scrab">스크랩수
                      </th><th className="t_center" id="unit_price">단{"    "}가</th>
                      <th className="t_center" id="price">금{"     "}액</th>
                    </tr>
                    { dynamicTrRow() }
                  </tbody>
                </table>
              ...
              <div className="supplyer_container">
                <table>
                  <tbody>
                    <tr>
                      <td className="t_center" rowSpan={5} id="t_rec_name">공<br></br>급<br />받<br></br>는<br />자</td>
                      <td className="t_center">등록 번호</td>
                      <td className="tl_width" colSpan={3} >{"503 - 81 - 53553"}</td>
                      <td className="t_center" rowSpan={5} id="t_sen_name" style={{borderLeftWidth: '4px', borderStyle: 'double'}}>공<br /><br />급<br /><br />자</td>
                      <td className="t_center">등록번호</td>
